...
contract RevertsTestSessionKey is Deploy {
    ...
    function test_revert_executeAA_invalidSessionKey_AA24() external {
        bytes memory callData = abi.encodeWithSelector(
            _RandomOwnerSC.execute.selector,
            _Target,
            0.1 ether,
    ...
    function test_revert_executeAA_revokedSessionKey_AA24() external {
        address[] memory whitelist = new address[](0);
    ...
    function test_revert_executeAA_sessionKeyReentry_AA24() external {
        address[] memory whitelist = new address[](0);
    ...
    function test_revert_executeAA_sessionKeyNotWhitelisted_AA24() external {
    ...
    function test_revert_executeBatchAA_sessionKeyNotWhitelisted_AA24() external {
        address[] memory whitelist = new address[](1);
        whitelist[0] = _Target;
        ...
        _deal(notWhitelisted, 1 ether);

        address[] memory targets = new address[](2);
        targets[0] = _Target;
        targets[1] = notWhitelisted;
    ...
    function test_revert_executeBatchAA_sessionKeyLimitExceeded_AA24() external {
        address[] memory whitelist = new address[](0);
