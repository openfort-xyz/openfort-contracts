...
contract SocialRecoveryTest is SocialRecoveryHelper {
    ...
    function test_revokeGuardianProposalDirect() external createGuardians(3) {
        _assertGuardianCount(0);
        _executeGuardianAction(randomOwner, GuardianAction.PROPOSE, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
        ...
        _assertPendingGuardians(3, false);
        _assertGuardians(3);
        _executeGuardianAction(randomOwner, GuardianAction.REVOKE, 3);
        _assertPendingGuardians(3, false);
        _assertGuardianCount(3);
        _assertGuardians(3);
    }
    ...
    function test_confirmGuardianRevocationDirect() external createGuardians(3) {
        _assertGuardianCount(0);
        _executeGuardianAction(randomOwner, GuardianAction.PROPOSE, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
        ...
        _assertGuardianCount(3);
        _assertGuardians(3);
        _executeGuardianAction(randomOwner, GuardianAction.CONFIRM_REVOCATION, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
    }

    function test_confirmGuardianRevocationAA() external createGuardians(3) {
        _assertGuardianCount(0);
        _executeGuardianAction(randomOwner, GuardianAction.PROPOSE, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
    ...
    function test_cancelGuardianRevocationDirect() external createGuardians(3) {
        _assertGuardianCount(0);
        _executeGuardianAction(randomOwner, GuardianAction.PROPOSE, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
        ...
        _assertGuardianCount(3);
        _assertGuardians(3);
        _executeGuardianAction(randomOwner, GuardianAction.CANCEL_REVOCATION, 3);
        _assertPendingGuardians(3, false);
        _assertGuardianCount(3);
        _assertGuardians(3);
    }

    function test_cancelGuardianRevocationAA() external createGuardians(3) {
        _assertGuardianCount(0);
        _executeGuardianAction(randomOwner, GuardianAction.PROPOSE, 3);
        _assertGuardianCount(0);
        _assertPendingGuardians(3, true);
