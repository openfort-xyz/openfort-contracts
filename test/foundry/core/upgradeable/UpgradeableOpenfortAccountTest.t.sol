...
import {UpgradeableOpenfortAccountFactory} from "contracts/core/upgradeable/UpgradeableOpenfortAccountFactory.sol";
...
contract UpgradeableOpenfortAccountTest is Test {
    ...
    UpgradeableOpenfortAccountFactory public upgradeableOpenfortAccountFactory;
     ...
     * Scenario:
     * - factoryAdmin is the deployer (and owner) of the UpgradeableOpenfortAccountFactory
    ...
    function setUp() public {
        ...
        upgradeableOpenfortAccountFactory = new UpgradeableOpenfortAccountFactory(IEntryPoint(payable(address(entryPoint))));
    ...
    function testCreateAccountViaFactory() public {
        ...
        address account = upgradeableOpenfortAccountFactory.getAddress(accountAdmin);
        ...
        upgradeableOpenfortAccountFactory.createAccount(accountAdmin, bytes(""));

        // Make sure the counterfactual address has not been altered
        assertEq(account, upgradeableOpenfortAccountFactory.getAddress(accountAdmin));
    }
    ...
    function testCreateAccountTestCounterDirect() public {
        ...
        address account = upgradeableOpenfortAccountFactory.createAccount(accountAdmin, "");
        ...
        UpgradeableOpenfortAccount(payable(account)).execute(address(testCounter), 0, abi.encodeWithSignature("count()"));
    ...
    function testCreateAccountWithNonce() public {
        // Create an static account wallet and get its address
        address account = upgradeableOpenfortAccountFactory.createAccount(accountAdmin, "");
        address account2 = upgradeableOpenfortAccountFactory.createAccount(accountAdmin, "");
        ...
        account2 = upgradeableOpenfortAccountFactory.createAccountWithNonce(accountAdmin, "", 0);
